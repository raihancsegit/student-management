                    ...
                    <div class="container">
                        <div class="col-md-10">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" _lpchecked="1" id="frm-add-section" method="">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="class_name">Class Name</label>
                                            <input type="text" class="form-control" id="class_name" name="class_name" placeholder="Enter Class Name" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" class="form-control" id="seats_available" name="seats_available" placeholder="Enter Seats" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
                                        </div>
